...
{
    public GraphRelationshipQueryable(GraphQueryProvider provider, AgeGraphContext graphContext, AgeGraphTransaction? transaction)
        : base(typeof(TRel), provider, graphContext, transaction, CreateRootExpression(), GraphQueryableKind.Relationship)
    {
    }

    public GraphRelationshipQueryable(GraphQueryProvider provider, AgeGraphContext graphContext, AgeGraphTransaction? transaction, Expression expression)
