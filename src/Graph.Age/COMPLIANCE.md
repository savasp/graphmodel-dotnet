...
- **GIN acceleration** (#291) — each label table has one coarse, blob-level GIN expression index over
  ...
  provisioning and by `IGraph.RecreateIndexesAsync`. Write amplification: a 5,000-node bulk insert of
