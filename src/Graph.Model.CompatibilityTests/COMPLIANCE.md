...
| | |
|---|---|
| Provider | \<Cvoya.Graph.Model.YourProvider\> \<provider version\> |
| Compliance suite | Cvoya.Graph.Model.CompatibilityTests \<suite version\> |
