# Cvoya.Graph.Model.CompatibilityTests

[![NuGet](https://img.shields.io/nuget/v/Cvoya.Graph.Model.CompatibilityTests.svg)](https://www.nuget.org/packages/Cvoya.Graph.Model.CompatibilityTests/)
...
```bash
dotnet add package Cvoya.Graph.Model.CompatibilityTests
```
...
- **[Cvoya.Graph.Model](https://www.nuget.org/packages/Cvoya.Graph.Model/)** - Core graph abstractions
- **[Cvoya.Graph.Model.Neo4j](https://www.nuget.org/packages/Cvoya.Graph.Model.Neo4j/)** - Neo4j database provider (the suite's in-tree reference implementation)
