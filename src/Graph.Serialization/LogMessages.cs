...
internal static partial class LogMessages
{
    ...
    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "ProcessDynamicProperties: Processing {PropertyCount} properties")]
    internal static partial void LogDebugEntityFactory533(this ILogger logger, global::System.Int32 propertyCount);

    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "ProcessDynamicProperties: Processing property '{PropertyName}' with value '{PropertyValue}' of type '{PropertyType}'")]
    ...
    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "ProcessDynamicProperties: Adding simple property '{PropertyName}' to simpleProperties")]
    internal static partial void LogDebugEntityFactory574(this ILogger logger, global::System.String propertyName);

    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "MaterializeAsync: TargetType={TargetType}, ElementType={ElementType}, IsCollectionType={IsCollectionType}, RecordCount={RecordCount}")]
    ...
    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "MaterializeAsync: ProcessAsync returned {EntityInfoCount} entity infos")]
    internal static partial void LogDebugGraphResultMaterializer65(this ILogger logger, global::System.Int32 entityInfoCount);

    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "MaterializeAsync: Final result type={ResultType}")]
    internal static partial void LogDebugGraphResultMaterializer71(this ILogger logger, global::System.String resultType);

    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "MaterializeAsync: Collection result contains {Count} items")]
    internal static partial void LogDebugGraphResultMaterializer75(this ILogger logger, global::System.Int32 count);

    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "MaterializeRecordAsync: ProcessAsync returned {EntityInfoCount} entity infos")]
    internal static partial void LogDebugGraphResultMaterializer93(this ILogger logger, global::System.Int32 entityInfoCount);

    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "MaterializeAsCollection: Processing {EntityInfoCount} entity infos for element type {ElementType}")]
    ...
    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "MaterializeAsCollection: Materialized {ElementCount} non-null elements")]
    internal static partial void LogDebugGraphResultMaterializer164(this ILogger logger, global::System.Int32 elementCount);

    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "MaterializeAsCollection: Converted to collection type {ResultType}")]
    internal static partial void LogDebugGraphResultMaterializer167(this ILogger logger, global::System.String resultType);

    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "MaterializeSingleElement: ElementType={ElementType}, ActualType={ActualType}, CanDeserialize={CanDeserialize}")]
    ...
    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "CreateComplexObject: Creating {TypeName} from EntityInfo with {SimpleCount} simple properties, {ComplexCount} complex properties")]
    ...
    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "CreateComplexObject: Simple property names: [{SimpleProps}]")]
    internal static partial void LogDebugGraphResultMaterializer283(this ILogger logger, global::System.String simpleProps);

    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "CreateComplexObject: Complex property types: [{ComplexProps}]")]
    internal static partial void LogDebugGraphResultMaterializer285(this ILogger logger, global::System.String complexProps);

    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "CreateComplexObject: Trying constructor with {ParamCount} parameters: [{Params}]")]
    ...
    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "CreateComplexObject: Parameter {ParamName} -> Property {PropertyFound} (Type: {PropertyType})")]
    ...
    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "CreateComplexObject: Parameter {ParamName} set to type {ValueType}")]
    ...
    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "CreateComplexObject: Successfully created {TypeName} instance")]
    internal static partial void LogDebugGraphResultMaterializer335(this ILogger logger, global::System.String typeName);

    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "CreateComplexObject: Constructor failed: {Exception}")]
    internal static partial void LogDebugGraphResultMaterializer340(this ILogger logger, global::System.String exception);

    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "Processing records for target type: {TargetType}")]
    internal static partial void LogDebugGraphResultProcessor44(this ILogger logger, global::System.String targetType);

    [LoggerMessage(EventId = 0, Level = LogLevel.Warning, Message = "No schema found for node type {NodeType}. Cannot deserialize complex properties.")]
    internal static partial void LogWarningGraphResultProcessor280(this ILogger logger, global::System.String nodeType);

    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "Complex property structure node has {PropertyCount} properties: [{Properties}]")]
    ...
    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "Complex properties found: {Count} items")]
    internal static partial void LogDebugGraphResultProcessor542(this ILogger logger, global::System.Int32 count);

    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "Created EntityInfo with {SimpleCount} simple properties: [{SimpleProps}], {ComplexCount} complex properties")]
    ...
    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "Using label-based type DynamicNode for target type {TargetType}")]
    internal static partial void LogDebugGraphResultProcessor1107(this ILogger logger, global::System.String targetType);

    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "Using metadata type {MetadataType} for target type {TargetType}")]
    ...
    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "Using label-based type {LabelType} for target type {TargetType}")]
    ...
    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "Falling back to target type {TargetType} for node with labels [{Labels}]")]
    ...
    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "Using relationship type-based type DynamicRelationship for target type {TargetType}")]
    ...
    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "Using relationship type-based type {LabelType} for target type {TargetType}")]
    ...
    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "Falling back to target type {TargetType} for relationship with type {RelType}")]
