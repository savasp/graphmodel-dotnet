...
public sealed class ComplianceInventoryTests
{
    ...
    // +9 for #466: zero/cancelled mutations, search and relationship-existence selection,
    ...
    // +4 for #481/#498: one shared duplicate ordinary-Id creation contract plus three final
    // provider-boundary certifications for the identity-free public shape, external native rows,
    // and read-only no-provision behavior.
    private const int ExpectedTotalTestMethods = 500;
