...
public class GraphTraversalTests : Model.Tests.AdvancedQueryTestsBase, IAsyncLifetime, IClassFixture<TestInfrastructureFixture>
{
    private readonly TestInfrastructureFixture fixture;

    public GraphTraversalTests(TestInfrastructureFixture fixture)
    {
