...
public class CG002_PropertyMustHavePublicAccessorsTests
{
    [Fact]
    ...
    public async Task NodeWithMixedAccessLevels_ProducesMultipleDiagnostics()
    {
        ...
        var expected = new[]
        {
            VerifyCS.Diagnostic("CG002").WithLocation(0).WithArguments("Name", "TestNode"),
            VerifyCS.Diagnostic("CG002").WithLocation(1).WithArguments("Description", "TestNode")
        };
