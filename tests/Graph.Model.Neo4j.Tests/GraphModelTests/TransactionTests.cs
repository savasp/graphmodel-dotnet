...
public class TransactionTests : Model.Tests.TransactionTestsBase, IAsyncLifetime, IClassFixture<TestInfrastructureFixture>
{
    private readonly TestInfrastructureFixture fixture;

    public TransactionTests(TestInfrastructureFixture fixture)
    {
