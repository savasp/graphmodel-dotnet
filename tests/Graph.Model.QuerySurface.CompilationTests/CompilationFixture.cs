...
namespace Cvoya.Graph.Model.QuerySurface.CompilationTests;

using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.CSharp;

/// <summary>
/// Compiles a snippet of C# source against the real <c>Cvoya.Graph.Model</c> assembly (plus the
...
internal static class CompilationFixture
{
    ...
    private static MetadataReference[] BuildReferences()
    {
        ...
        // Reference the real Cvoya.Graph.Model assembly under test.
