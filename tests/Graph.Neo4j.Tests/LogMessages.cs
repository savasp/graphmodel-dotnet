...
{
    [LoggerMessage(EventId = 1, Level = LogLevel.Error, Message = "Error executing scheduled task")]
    internal static partial void LogErrorBackgroundWorker30(this ILogger logger, Exception exception);

    [LoggerMessage(EventId = 2, Level = LogLevel.Error, Message = "Error executing scheduled task")]
    internal static partial void LogErrorBackgroundWorker51(this ILogger logger, Exception exception);

    [LoggerMessage(EventId = 3, Level = LogLevel.Debug, Message = "Disposing DatabasePool")]
    internal static partial void LogDebugDatabasePoolManager106(this ILogger logger);

    [LoggerMessage(EventId = 4, Level = LogLevel.Debug, Message = "Requesting an available database from the pool")]
    internal static partial void LogDebugDatabasePoolManager127(this ILogger logger);

    [LoggerMessage(EventId = 5, Level = LogLevel.Debug, Message = "A database is available, acquiring it")]
    internal static partial void LogDebugDatabasePoolManager135(this ILogger logger);

    [LoggerMessage(EventId = 6, Level = LogLevel.Debug, Message = "Acquired database {DatabaseName} from the pool")]
    internal static partial void LogDebugDatabasePoolManager139(this ILogger logger, global::System.String databaseName);

    [LoggerMessage(EventId = 7, Level = LogLevel.Debug, Message = "Releasing database {DatabaseName} back to the pool")]
    internal static partial void LogDebugDatabasePoolManager147(this ILogger logger, global::System.String databaseName);

    [LoggerMessage(EventId = 8, Level = LogLevel.Debug, Message = "Database {DatabaseName} is now available in the pool")]
    internal static partial void LogDebugDatabasePoolManager151(this ILogger logger, global::System.String databaseName);

    [LoggerMessage(EventId = 9, Level = LogLevel.Debug, Message = "Cleaning database {DatabaseName}")]
    internal static partial void LogDebugDatabasePoolManager166(this ILogger logger, global::System.String databaseName);

    [LoggerMessage(EventId = 10, Level = LogLevel.Debug, Message = "Database {DatabaseName} cleaned successfully")]
    internal static partial void LogDebugDatabasePoolManager170(this ILogger logger, global::System.String databaseName);

    [LoggerMessage(EventId = 11, Level = LogLevel.Information, Message = "Setting up {Count} databases in the pool (max concurrency: {Concurrency})")]
    ...
    [LoggerMessage(EventId = 12, Level = LogLevel.Debug, Message = "Creating database {DatabaseName} in the pool")]
    internal static partial void LogDebugDatabasePoolManager190(this ILogger logger, global::System.String databaseName);

    [LoggerMessage(EventId = 13, Level = LogLevel.Debug, Message = "Database {DatabaseName} is ready for use ({Count}/{Total}, {Elapsed:F1}s)")]
    ...
    [LoggerMessage(EventId = 14, Level = LogLevel.Error, Message = "Failed to create database {DatabaseName}, skipping")]
    ...
    [LoggerMessage(EventId = 15, Level = LogLevel.Information, Message = "Database pool setup complete: {SuccessCount} ready, {FailCount} failed in {Elapsed:F1}s")]
    ...
    [LoggerMessage(EventId = 16, Level = LogLevel.Debug, Message = "Creating database {DatabaseName} if it does not exist")]
    internal static partial void LogDebugDatabasePoolManager231(this ILogger logger, global::System.String databaseName);

    [LoggerMessage(EventId = 17, Level = LogLevel.Debug, Message = "Database {DatabaseName} is now ready")]
    internal static partial void LogDebugDatabasePoolManager236(this ILogger logger, global::System.String databaseName);

    [LoggerMessage(EventId = 18, Level = LogLevel.Warning, Message = "Neo4j database administration is unavailable; using shared default database {DatabaseName} for tests ({FailCount} database-create failures)")]
    ...
    [LoggerMessage(EventId = 19, Level = LogLevel.Information, Message = "Shared default database {DatabaseName} is ready in {Elapsed:F1}s")]
    ...
    [LoggerMessage(EventId = 20, Level = LogLevel.Debug, Message = "Scheduling drop of database {DatabaseName}")]
    internal static partial void LogDebugDatabasePoolManager256(this ILogger logger, global::System.String databaseName);

    [LoggerMessage(EventId = 21, Level = LogLevel.Debug, Message = "Dropping database {DatabaseName}")]
    internal static partial void LogDebugDatabasePoolManager259(this ILogger logger, global::System.String databaseName);

    [LoggerMessage(EventId = 22, Level = LogLevel.Debug, Message = "Database {DatabaseName} dropped successfully")]
    internal static partial void LogDebugDatabasePoolManager263(this ILogger logger, global::System.String databaseName);

    [LoggerMessage(EventId = 23, Level = LogLevel.Warning, Message = "Failed to drop database {DatabaseName}. It may not exist or is already dropped.")]
    internal static partial void LogWarningDatabasePoolManager267(this ILogger logger, global::System.String databaseName);

    [LoggerMessage(EventId = 24, Level = LogLevel.Debug, Message = "Waiting for database {DatabaseName} to become available for driver connections")]
    internal static partial void LogDebugDatabasePoolManager274(this ILogger logger, global::System.String databaseName);

    [LoggerMessage(EventId = 25, Level = LogLevel.Debug, Message = "Database {DatabaseName} is now online")]
    internal static partial void LogDebugDatabasePoolManager283(this ILogger logger, global::System.String databaseName);

    [LoggerMessage(EventId = 26, Level = LogLevel.Debug, Message = "Database {DatabaseName} not yet available, attempt {Attempt}/{MaxAttempts}")]
    ...
    [LoggerMessage(EventId = 27, Level = LogLevel.Debug, Message = "Error checking database {DatabaseName}, attempt {Attempt}/{MaxAttempts}: {Error}")]
    ...
    [LoggerMessage(EventId = 28, Level = LogLevel.Debug, Message = "Disposing test infrastructure fixture")]
    internal static partial void LogDebugTestInfrastructureFixture65(this ILogger logger);

    [LoggerMessage(EventId = 29, Level = LogLevel.Debug, Message = "Reusing existing database: {DatabaseName}")]
    internal static partial void LogDebugTestInfrastructureFixture94(this ILogger logger, global::System.String databaseName);

    [LoggerMessage(EventId = 30, Level = LogLevel.Debug, Message = "Getting new database for test")]
    internal static partial void LogDebugTestInfrastructureFixture99(this ILogger logger);

    [LoggerMessage(EventId = 31, Level = LogLevel.Information, Message = "Initializing test: {TestName}")]
    internal static partial void LogInformationNeo4jTest29(this ILogger logger, global::System.String testName);

    [LoggerMessage(EventId = 32, Level = LogLevel.Information, Message = "Test {TestName} initialized successfully")]
